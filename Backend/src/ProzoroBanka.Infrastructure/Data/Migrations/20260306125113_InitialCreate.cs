        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedMonobankToken = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonobankTransactions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParsedBy = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonobankTransactionId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MatchResults_MonobankTransactions_MonobankTransactionId",
                        column: x => x.MonobankTransactionId,
                        principalTable: "MonobankTransactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchResults_MonobankTransactionId",
                table: "MatchResults",
                column: "MonobankTransactionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonobankTransactions_ExternalId",
                table: "MonobankTransactions",
                column: "ExternalId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MonobankTransactions_UserId",
                table: "MonobankTransactions",
                column: "UserId");
