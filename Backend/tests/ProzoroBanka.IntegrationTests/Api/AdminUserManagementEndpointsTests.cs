...
public class AdminUserManagementEndpointsTests : IClassFixture<TestWebApplicationFactory>
{
    ...
    public async Task ImpersonateUser_AsModerator_ReturnsTargetUserTokens()
    {
        ...
        var accessToken = AuthTestHelpers.ExtractCookieValue(impersonateResponse, AuthTestHelpers.AccessTokenCookieName);
        Assert.False(string.IsNullOrWhiteSpace(accessToken));
        AuthTestHelpers.ApplyCsrfHeader(_client, impersonateResponse);
