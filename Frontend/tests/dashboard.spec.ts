...
async function openCreateOrgDialogFromOnboarding(
  page: import("@playwright/test").Page,
  onboardingPage: {
    goto: () => Promise<void>;
    createOrgButton: {
  ...
  await onboardingPage.createOrgButton.waitFor({
    state: "visible",
    timeout: 10000,
  });
  await onboardingPage.openCreateOrganizationDialog();
...
test.describe("Dashboard — Organization Creation", () => {
  ...
  test("TC-01: Create organization dialog opens with all required fields", async ({
    page,
    onboardingPage,
    createOrgDialog,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that the create organization dialog opens and displays all required form fields.",
    });
  ...
  test("TC-02: Successfully create a new organization with valid data", async ({
    page,
    onboardingPage,
    createOrgDialog,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that creating an organization with valid data succeeds and redirects to the dashboard.",
    });
    ...
    await createOrgDialog.fill(
      orgName,
      "Test organization for E2E testing",
      "https://example.org",
    );
    ...
    const createResponse = await createOrgDialog.submitAndWaitForCreate();
    ...
    await expect(
      page.getByRole("heading", { level: 1, name: orgName, exact: true }),
    ).toBeVisible({ timeout: 10000 });
  });

  test("TC-03: Validation prevents creating organization with empty name", async ({
    page,
    onboardingPage,
    createOrgDialog,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that submitting without a name shows a validation error.",
    });

    await openCreateOrgDialogFromOnboarding(page, onboardingPage);

    await createOrgDialog.submit();

    await expect(page.getByText(t("validation.orgNameMin"))).toBeVisible({
      timeout: 5000,
    });
    await expect(page.getByRole("dialog")).toBeVisible();
  });

  test("TC-04: Validation prevents creating organization with name too short", async ({
    page,
    onboardingPage,
    createOrgDialog,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that entering a name shorter than 3 characters shows a validation error.",
    });
  ...
  test("TC-05: Validation prevents creating organization with invalid website URL", async ({
    page,
    onboardingPage,
    createOrgDialog,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that entering an invalid website URL shows a validation error.",
    });
    ...
    await expect(page.getByText(t("validation.urlInvalid"))).toBeVisible({
      timeout: 5000,
    });
  });

  test("TC-06: Slug is auto-generated from organization name", async ({
    page,
    onboardingPage,
    createOrgDialog,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that the slug field is automatically populated based on the name input.",
    });
  ...
  test("TC-07: User can override the auto-generated slug", async ({
    page,
    onboardingPage,
    createOrgDialog,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that after auto-generation, the user can manually edit the slug.",
    });
  ...
  test("TC-08: Cancel button closes dialog without creating organization", async ({
    page,
    onboardingPage,
    createOrgDialog,
  }) => {
    ...
    await createOrgDialog.close();

    await expect(page.getByRole("dialog")).not.toBeVisible();
  });

  test("TC-09: Create organization shows error message on API failure", async ({
    page,
    onboardingPage,
    createOrgDialog,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that when the API call fails, an error message is displayed.",
    });
    ...
    await expect(
      page.getByText(/already exists|вже існує/i).first(),
...
test.describe("Dashboard — Organization Settings", () => {
  ...
  test("TC-10: Organization settings page displays current organization data", async ({
    page,
    orgSettingsPage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that the settings page loads and shows the organization fields.",
    });

    await expect(
      page.getByRole("heading", { name: t("nav.settings") }),
    ).toBeVisible();
  ...
  test("TC-11: Update organization name and save changes", async ({
    orgSettingsPage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that updating the organization name persists the change.",
    });
    ...
    const updateResponse = await orgSettingsPage.saveAndWaitForUpdate(orgId);
    expect(updateResponse.ok()).toBeTruthy();

    await expect(orgSettingsPage.successAlert).toBeVisible({ timeout: 5000 });
    await expect(orgSettingsPage.nameInput).toHaveValue(newValue);
  });

  test("TC-12: Update organization description and save changes", async ({
    orgSettingsPage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that updating the organization description persists correctly.",
    });
  ...
  test("TC-13: Update organization website URL", async ({
    orgSettingsPage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that updating the organization website URL persists correctly.",
    });
  ...
  test("TC-14: Update organization contact email", async ({
    orgSettingsPage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that updating the organization contact email persists correctly.",
    });
  ...
  test("TC-15: Update organization phone number", async ({
    orgSettingsPage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that updating the organization phone number persists correctly.",
    });
  ...
  test("TC-16: Save button is disabled when no changes are made", async ({
    orgSettingsPage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that the save button is disabled when the form has not been modified.",
    });

    await expect(orgSettingsPage.saveButton).toBeDisabled();
  });

  test("TC-17: Validation prevents saving with invalid contact email", async ({
    page,
    orgSettingsPage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that entering an invalid email shows a validation error.",
    });
  ...
  test("TC-18: Validation prevents saving with invalid phone format", async ({
    page,
    orgSettingsPage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that entering an invalid phone number shows a validation error.",
    });
  ...
  test("TC-19: Settings update shows error message on API failure", async ({
    page,
    orgSettingsPage,
  }) => {
    test.info().annotations.push({
...
test.describe("Dashboard — Home Page", () => {
  ...
  test("TC-20: Dashboard home page displays organization statistics", async ({
    page,
    dashboardHomePage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that the dashboard home page shows organization stats.",
    });

    await expect(
      page.getByText(t("dashboard.statMembers"), { exact: true }),
    ).toBeVisible();
    await expect(
      page.getByText(t("dashboard.statActiveCampaigns"), { exact: true }),
    ).toBeVisible();
    await expect(
      page.getByText(t("dashboard.statRaised"), { exact: true }),
    ).toBeVisible();
    await expect(
      page.locator("main").getByText(t("dashboard.statReceipts")).first(),
    ).toBeVisible();
  ...
  test("TC-21: Dashboard home page shows quick start guide", async ({
    page,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that the dashboard home page displays the quick start guide.",
    });
  ...
  test("TC-22: Dashboard sidebar navigation links work correctly", async ({
    page,
    dashboardHomePage,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that clicking sidebar navigation links navigates to the correct pages.",
    });
...
test.describe("Dashboard — Edge Cases", () => {
  ...
  test("TC-23: Unauthenticated users are redirected from dashboard to login", async ({
    page,
  }) => {
    test.info().annotations.push({
      type: "description",
      description:
        "Verifies that accessing the dashboard without authentication redirects to login.",
    });
