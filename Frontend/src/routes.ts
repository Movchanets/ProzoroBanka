...
export default [
  ...
  layout("layouts/AuthGuard.tsx", [
    ...
    route("dashboard/:orgId", "components/DashboardLayout.tsx", [
      ...
      route("purchases/:purchaseId", "pages/Dashboard/OrganizationPurchaseDetailPage.tsx"),
      ...
      route("campaigns/:campaignId/purchases/new", "pages/Dashboard/CampaignPurchaseCreatePage.tsx"),
      route("campaigns/:campaignId/purchases/:purchaseId", "pages/Dashboard/CampaignPurchaseDetailPage.tsx"),
